...
wp i18n make-pot $PROJECT_PATH $DEFAULT_TEMPLATE_PATH --domain=$TEXT_DOMAIN --exclude=$PROJECT_PATH --include=$PROJECT_PATH/src,$PROJECT_PATH/templates --allow-root
echo "Done!"